...
public class HealthArticlesActivity extends AppCompatActivity {
    ...
    private String[][] health_details =
    {
        ...
        {"healthy sleep habit","","","","Click for more details"},
        {"Healthy Gut","","","","Click for more details"}
    };

    private int[] images = {
        R.drawable.walking_daily,
        R.drawable.home_care_of_covid,
        R.drawable.stop_smoking,
        R.drawable.healthy_sleep_habit,
        R.drawable.healthy_gut
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView textView = findViewById(R.id.textViewHA);
