...
//                int intValue = Integer.parseInt(edPincode.getText().toString());
                db.addOrder(username,edName.getText().toString(),edAddress.getText().toString(),edContact.getText().toString(), edPincode.getText().toString(),date.toString(),time.toString(),price[1].toString(),"lab");
